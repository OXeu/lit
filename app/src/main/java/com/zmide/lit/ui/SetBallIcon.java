...
public class SetBallIcon extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		path = "ball_icon.png";// new File(getExternalCacheDir(), "wallpaper.png").getAbsolutePath();
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == PHOTO_ALBUM_REQUEST && resultCode == RESULT_OK) {
			...
			if (uri == null) {
				...
				sp.edit().putBoolean("ball_icon", !sp.getBoolean("ball_icon", true)).apply();
				//startImageZoom(uri);
			}
		}
		/*
